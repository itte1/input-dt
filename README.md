...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/input-dt@0.0.4/input-dt-min.css">
<script type="module" src="https://cdn.jsdelivr.net/npm/input-dt@0.0.4/input-dt-min.js"></script>
```
